...
from app.views.bookings import QuoteBookingView, AcceptBookingView, DeclineBookingView, VenueDeclineBookingView, BookingView, BookingsView, NewBookingView, VenueBookingView
